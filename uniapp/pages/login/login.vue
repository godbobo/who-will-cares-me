<template>
	<view class="login">
		...
		<view class="content">
			...
			<wButton text="登 录" :rotate="isRotate" @on-click="startLogin"></wButton>
...
<script>
	...
	import * as md5Util from '@/utils/md5Util'
	...
	export default {
		...
		methods: {
			...
			async startLogin() {
				...
				this.isRotate = true
				try{
					const str = this.phoneData+this.passData+this.$config.slat
					this.$store.commit('SET_TOKEN', md5Util.hex_md5(str))
					await this.login()
